...
in
{
  options.services.gowitness = {
    ...
    dataPath = lib.mkOption {
      ...
      description = "The directory where gowitness stores its data files.";
    };

    screenshotPath = lib.mkOption {
      type = lib.types.path;
      default = "/var/lib/gowitness/screenshots";
      description = "The path where screenshots are stored.";
    };
    ...
    user = lib.mkOption {
      ...
      default = "gowitness";
      description = "The gowitness service user.";
    };

    group = lib.mkOption {
      type = lib.types.nonEmptyStr;
      default = "gowitness";
      description = "The gowitness service group.";
    };
  };
